...
async def create_inbound_dispatch():
    """Create inbound dispatch rule with agent assignment"""
    ...
    try:
        ...
        print(f"✅ Inbound dispatch rule created: {rule.sip_dispatch_rule_id}")
        print(f"   Agent assigned: {AGENT_NAME}")
        print(f"   Room pattern: call-_<caller>_<random>")
...
if __name__ == "__main__":
    asyncio.run(create_inbound_dispatch())
